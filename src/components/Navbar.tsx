    ...
    <nav className="relative">
      <div
        ...
        <div className="w-full h-[10dvh] flex justify-between items-center">
          ...
          <div className="hidden md:flex justify-start items-center gap-6 lg:gap-10 font-bold -translate-x-8">
            <div className="relative group">
              <Link className="transition duration-300" href="/">
                Home
              </Link>
              <div className="absolute left-0 bottom-0 w-0 h-[2px] bg-[#6343f3] transition-all duration-300 group-hover:w-full"></div>
            </div>
            <div className="relative group">
            ...
            <div className="relative group">
              <Link className="transition duration-300" href="/work">
                Work
              </Link>
              <div className="absolute left-0 bottom-0 w-0 h-[2px] bg-[#6343f3] transition-all duration-300 group-hover:w-full"></div>
            </div>
            <Link
              className="text-[#6343f3] transition duration-300"
          ...
          <div className="md:flex hidden justify-center items-center space-x-5">
            <Link href="https://github.com/Creative-Wave" target="_blank">
              <Github />
            </Link>
